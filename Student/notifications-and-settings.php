...
if ($currentStudent) {
    $studentName = $currentStudent['NameAr'] ?? $currentStudent['NameEn'] ?? 'Student';
    $studentEmail = $currentStudent['Email'] ?? '';
    $studentPhone = $currentStudent['Phone'] ?? '';
    $studentCode = $currentStudent['Student_Code'] ?? '';
    $studentAddress = $currentStudent['Address'] ?? '';
    $studentDOB = $currentStudent['Date_Of_Birth'] ?? '';
    $studentNationalId = $currentStudent['National_ID'] ?? '';

    $classId = $currentStudent['Class_ID'] ?? null;
    if ($classId) {
        try {
            ...
            if ($classInfo) {
                $studentGrade = $classInfo['Grade_Level'] ?? '';
                $studentSection = $classInfo['Section'] ?? '';
        ...
        <div class="card">
            ...
            <div class="settings-content active" id="profileTab">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo htmlspecialchars($studentName); ?>" readonly style="background: #f5f5f5; cursor: not-allowed;">
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label data-en="Student Code" data-ar="رقم الطالب">Student Code</label>
                        <input type="text" value="<?php echo htmlspecialchars($studentCode); ?>" readonly style="background: #f5f5f5; cursor: not-allowed;">
                    </div>
                    <div class="form-group">
                        <label data-en="Grade" data-ar="الصف">Grade</label>
                        <input type="text" value="<?php echo htmlspecialchars($studentGrade); ?>" readonly style="background: #f5f5f5; cursor: not-allowed;">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label data-en="Section" data-ar="الشعبة">Section</label>
                        <input type="text" value="<?php echo htmlspecialchars($studentSection); ?>" readonly style="background: #f5f5f5; cursor: not-allowed;">
                    </div>
                    <div class="form-group">
                        <label data-en="Class Name" data-ar="اسم الفصل">Class Name</label>
                        <input type="text" value="<?php echo htmlspecialchars($studentClassName); ?>" readonly style="background: #f5f5f5; cursor: not-allowed;">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label data-en="Date of Birth" data-ar="تاريخ الميلاد">Date of Birth</label>
                        <input type="text" value="<?php echo $studentDOB ? date('Y-m-d', strtotime($studentDOB)) : ''; ?>" readonly style="background: #f5f5f5; cursor: not-allowed;">
                    </div>
                    <div class="form-group">
                        <label data-en="National ID" data-ar="رقم الهوية">National ID</label>
                        <input type="text" value="<?php echo htmlspecialchars($studentNationalId); ?>" readonly style="background: #f5f5f5; cursor: not-allowed;">
                    </div>
                </div>
                <div class="form-group">
                    <label data-en="Address" data-ar="العنوان">Address</label>
                    <input type="text" value="<?php echo htmlspecialchars($studentAddress); ?>" readonly style="background: #f5f5f5; cursor: not-allowed;">
                </div>
                    ...
                    <form onsubmit="updateContactInfo(event)">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="email" id="profileEmail" value="<?php echo htmlspecialchars($studentEmail); ?>" required>
                            </div>
                            <div class="form-group">
                                <label data-en="Phone Number" data-ar="رقم الهاتف">Phone Number</label>
                                <input type="tel" id="profilePhone" value="<?php echo htmlspecialchars($studentPhone); ?>" required>
                            </div>
                        </div>
